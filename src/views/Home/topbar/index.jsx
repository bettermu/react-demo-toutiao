/*
 * @Author: bettermu 
 * @Date: 2018-05-18 10:51:54 
 * @Last Modified by: bettermu
 * @Last Modified time: 2018-05-18 16:10:51
 * 新闻分类组件
 */
  ...
  render() {
    ...
    return (
      <div className="home-topbar-wrapper border-half-bottom">
        ...
        <a className="top-menu-more-btn df-c" href="javascript:;" onClick={() => { this.setState({ isTopBarBox: true }) }}>
          <i className="list-shadow"></i>
          <span className="cross"></span>
        </a>
        <TopBarBox className={isTopBarBox ? 'top-bar-active' : ''} closeBox={this.closeBox.bind(this)}></TopBarBox>
      </div>
    )
  }
}
